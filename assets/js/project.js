...
$(document).ready(function () {
  ...
  if ($('#project-board').length) {
    ...
    var drake = dragula([document.querySelector('#kanban-1'), document.querySelector('#kanban-2'), document.querySelector('#kanban-3')]).on('drop', drop); //Update column items count after a task has been moved
