...
$(document).ready(function () {
  ...
  if ($('#pickaday-datepicker').length) {
    var picker = new Pikaday({
      ...
      format: 'D MMM YYYY',
      onSelect: function () {//Do your stuff
      }
    });
  ...
  if ($('#autocomplete-demo-simple').length) {
    var demoSimpleOptions = {
      ...
      list: {
        ...
        onChooseEvent: function () {//do your stuff here
        }
      }
    };
  ...
  if ($('#video-player').length) {
    ...
    const $target = document.querySelector('audio[controls], video[controls]'); // assign media player from target (all these options represent the defaults)
